...
Al finalizar el recorrido de este libro, se espera que el lector pueda:

- reconocer cómo se articulan HTML, CSS y JavaScript en una interfaz web;
- estructurar páginas con HTML semántico y con criterios básicos de accesibilidad;
- aplicar estilos con CSS y elegir herramientas complementarias como SASS o frameworks con mayor criterio;
...
A continuación, se presenta el lenguaje HTML (HyperText Markup Language), que permite estructurar el contenido de las páginas web. A partir de ejemplos y ejercicios, se explora cómo organizar la información de manera clara, semántica y accesible, respetando los estándares actuales.

Luego, se introduce CSS (Cascading Style Sheets), el lenguaje que define la presentación visual de los sitios. Se estudian sus reglas básicas, su sintaxis, y se avanza hacia conceptos más complejos como el modelo de cajas y la disposición de elementos con flexbox y grid. También se incluye el uso de preprocesadores como SASS, que facilitan un código más eficiente y ordenado.

Más adelante, se exploran dos de los frameworks de CSS más utilizados actualmente: Bootstrap y Tailwind CSS. Estas herramientas facilitan el diseño y desarrollo de interfaces modernas, adaptables y reutilizables, sin necesidad de comenzar desde cero.

El libro dedica un capítulo especial a la accesibilidad web y al diseño responsive, promoviendo la creación de sitios que puedan ser utilizados por cualquier persona, en cualquier dispositivo y bajo distintas condiciones tecnológicas.

Finalmente se introduce JavaScript, el lenguaje que permite agregar interactividad y dinamismo a las páginas. Se explican los conceptos esenciales del lenguaje (con énfasis en la versión moderna, ECMAScript), el manejo del DOM (Document Object Model), técnicas básicas de debugging y la interacción con el usuario mediante eventos y manipulaciones dinámicas del contenido.

Este libro propone un enfoque práctico, claro y progresivo, pensado para acompañar el proceso de aprendizaje de quienes se inician en el desarrollo web frontend.
...
Para aprovechar este libro alcanza con un navegador actualizado y un editor de código. Un navegador moderno como Chrome, Firefox o Edge permite inspeccionar páginas, probar cambios y usar herramientas de desarrollo. Un editor como Visual Studio Code facilita la escritura y organización del código, aunque cualquier editor de texto plano puede servir para los primeros ejercicios.
